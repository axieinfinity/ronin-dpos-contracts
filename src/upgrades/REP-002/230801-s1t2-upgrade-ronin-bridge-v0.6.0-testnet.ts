...
const deploy = async ({ getNamedAccounts, deployments, ethers }: HardhatRuntimeEnvironment) => {
  ...
  const BridgeTrackingInstr = [
    proxyInterface.encodeFunctionData('upgradeTo', [BridgeTrackingLogic.address]),
...
// yarn hardhat deploy --tags 230801_S1T2_UpgradeRoninBridge_V0_6_0 --network ronin-testnet
deploy.tags = ['230801_S1T2_UpgradeRoninBridge_V0_6_0'];
