...
import "../../interfaces/validator/IRoninValidatorSetCoinbase.sol";
...
import "./RoninValidatorSetCoinbaseHelper.sol";
import "./RoninValidatorSetCommon.sol";

abstract contract RoninValidatorSetCoinbase is
  ...
  RoninValidatorSetCoinbaseHelper
{
  ...
  /**
   * @inheritdoc IRoninValidatorSetCoinbase
   */
